...
export default function EmailSignatureTemplate(props: {
  ...
  return (
    <div className="flex p-6 justify-items-center h-screen">
      <div className="w-1/2">
        <form
          style={{
            width: "250px",
