...
export default function SetupForSignature({ id }: { id: string }) {
  return (
    <div className="pt-6" id={id}>
      <h2 className="text-base font-medium text-black pb-7">
        Instructions to Set Up Your Email Signature
      </h2>

      <Accordion type="single" collapsible className="bg-slate-100 px-4">
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent>
            <small className="text-sm leading-none font-medium text-slate-900">
