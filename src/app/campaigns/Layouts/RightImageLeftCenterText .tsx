...
import DynamicStructureVoicestack from "@/app/components/DynamicStructureVoicestack";
import DynamicStructureWebinar from "@/app/components/DynamicStructureWebinar";
import DynamicStructureCenter from "@/app/components/DynamicStructureCenter";
        ...
        >
          <div className="flex-grow flex items-center gap-4 md:gap-16 xl:gap-24">
             ...
             {campaign?.structure?.campaignvideoUrl ? (
              <div className="items-center max-w-[450px] hidden lg:block flex-1 rounded-xl overflow-hidden">
                 <Image
              ...
              className="items-center max-w-[450px] hidden lg:block flex-1 rounded-xl overflow-hidden"
              isCarousal={
            ...
            <DynamicStructureCenter
              colors={colors}
              campaign={campaign}
              components={campaign?.structure?.components}
              className="flex flex-col max-w-xl xl:max-w-[570px] text-center w-full"
            />
