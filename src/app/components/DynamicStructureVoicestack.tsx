...
const DynamicStructureVoicestack = ({
  campaign,
  components,
  className,
  colors,
    ...
    block: {
      normal: ({ children }: any) => (
        <p
          ...
          className={`${campaign?.size ? campaign?.size : "text-[48px]"} font-medium !leading-[118%] font-geist lg:max-w-[600px] mb-6`}
        >
          {children}
        </p>
      ),
            ...
            const subTitleComponentsFor = {
              block: {
                normal: ({ children }: any) => (
                  <p
                    style={{ color: colors?.subtitleText }}
                    className={`${sizeClass} font-bold !leading-[118%] font-sans lg:max-w-[600px] mb-6`}
                  >
                    {children}
                  </p>
                ),
              ...
              marks: {
                ...subTitleComponent.marks,
                "highlight-bg": ({ children }: any) => (
                  <span style={{ backgroundColor: colors?.highlightColor }}>{children}</span>
                ),
              },
            };
          ...
          case "buttonComponents":
            return (
              <div
                ...
                className="flex gap-6 items-center mb-6 mt-2"
              >
...
export default DynamicStructureVoicestack;
